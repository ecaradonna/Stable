...
import SYIMacroAnalysisChart from "../components/SYIMacroAnalysisChart";
import StablecoinMarketCharts from "../components/StablecoinMarketCharts";
...
const IndexDashboardPage = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* SYI Historical Performance Chart */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Track the StableYield Index performance over time with comprehensive 
              historical data, trend analysis, and volatility metrics.
            </p>
          </div>
          
          {/* SYI Macro Analysis - Full Interactive Component */}
